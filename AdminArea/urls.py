...
urlpatterns = [
    ...
    path('campaigns/view/<int:campaign_id>', views.campaignView, name='campaignView'),    
    path('campaigns/delete/<int:campaign_id>', views.campaignDelete, name='campaignDelete'),
