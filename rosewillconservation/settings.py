"""
Django settings for rosewillconservation project.
...
ROOT_URLCONF = "rosewillconservation.urls"
...
WSGI_APPLICATION = "rosewillconservation.wsgi.application"
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'rosewillconservation/static')
]
MEDIA_URL = '/files/'
